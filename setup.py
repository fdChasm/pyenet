...
try:
    ...
    print("You must install Cython first; 'pip install cython'")
    sys.exit(1)

if not os.path.exists('./enet'):
    os.system("curl http://enet.bespin.org/download/enet-1.3.9.tar.gz | tar -xz && ln -s enet-1.3.9 enet")
